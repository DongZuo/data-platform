...
public enum BussinessCode {
	...
	//	// 成功
	GLOBAL_SUCCESS(0,"成功"),
	GLOBAL_OP_SUCCESS(0,"操作成功"),
	//	//
//	GLOBAL_ERROR("9999", "系统正在维护中,请稍后再试!"),
	// 成功
	GLOBAL_LOGIN_SUCCESS(0,"登陆成功"),
	//
	GLOBAL_NOT_LOGIN(1,"未登录"),

	GLOBAL_ERROR(9999, "系统正在维护中,请稍后再试!"),

	GLOBAL_DB_ERROR(2, "数据库操作失败,请求参数缺失"),
    GLOBAL_UP_ERROR(3, "上传文件失败"),
	GLOBAL_GETLOGIN_SUCCESS(0,"获取权限成功"),

	GLOBAL_DAILY_SUCCESS(0,"日报列表获取成功"),
	GLOBAL_BACK_SUCCESS(0,"回溯数据"),
	GLOBAL_LIST_SUCCESS(0,"获取表单成功"),
