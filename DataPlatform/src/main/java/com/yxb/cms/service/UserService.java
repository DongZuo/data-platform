...
import com.yxb.cms.dao.CcChartsMapper;
import com.yxb.cms.dao.CcIndexMapper;
...
public class UserService {
    ...
    @Autowired
    private CcIndexMapper ccIndexMapper;

    @Autowired
    private CcChartsMapper ccChartsMapper;
     ...
     * @return
     */
    public String selectIndexByUserName(String userName){
    	List<CcIndex> indexList = ccIndexMapper.selectByUserNameList(userName);
    	String indexType = indexList.get(0).getIndexType();
    	for (int i = 0; i < indexList.size(); i++) {
    		List<Map<String, Object>> list = jdbcTemplate.queryForList(indexList.get(i).getIndexSql());
    		indexList.get(i).setSql(String.valueOf(list.get(0).get("_val")));
		}
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("code",0);
        map.put("msg","");
        map.put("count",indexList.size());
        map.put("data", indexList);
     ...
     * @return
     */
    public String selectChartsByUserName(CcIndex index,String currentTime){
    	List<CcIndex> indexList = ccChartsMapper.selectByUserNameList(index);
    	String sql = indexList.get(0).getIndexSql();
    	String title = indexList.get(0).getIndexName();
    	String indexType = indexList.get(0).getIndexType();
    	//SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
    	//sql = sql.replaceAll("\\{current_time\\}", "'"+format.format(new Date())+" "+currentTime+"'");
    	sql = sql.replaceAll("\\{current_time\\}", "'"+currentTime+"'");
    	//System.out.println(sql);
    	//Map<String, Object> val = jdbcTemplate.queryForMap(sql);
     ...
     * @return
     */
    public String selectChartsByUserNameInit(CcIndex index){
    	List<CcIndex> indexList = ccChartsMapper.selectByUserNameList(index);
    	String sql = indexList.get(0).getInitSql();
    	String title = indexList.get(0).getIndexName();
    	String indexType = indexList.get(0).getIndexType();
    	List<Map<String, Object>> list = jdbcTemplate.queryForList(sql);
    	...
    	for (Map<String, Object> map : list) {
    		keys.add(String.valueOf(map.get("_key")));
    		values.add(String.valueOf(map.get("_val")));
		}
    	Map<String, Object> map = new HashMap<String, Object>();
        map.put("code",0);
        map.put("msg","");
     ...
     * @return
     */
    public String updatePassByUserLoginName(String userLoginName,String pass){
    	Map<String,String> params = new HashMap<String, String>();
    	String encodeStr=DigestUtils.md5Hex(pass);
    	params.put("userPassword", encodeStr);
    	params.put("userLoginName", userLoginName);
    	int i  = userMapper.updatePass(params);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("code",i);
        return Json.toJson(map);
    }
     ...
     * @return
     */
    public User selectUserRolesByUserId(Long userId){
        if(userId != null){
